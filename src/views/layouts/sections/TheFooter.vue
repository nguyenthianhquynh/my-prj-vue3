...
<template>
    <div class="bg-dark-brown">
        <footer class="grid grid-rows-6 gap-4">
            <div class="row-span-5  p-[50px]">
                <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 gap-4">
                    <div class="self-center">
                        <div class="col-span-2">
                            <div>
                                <BrandLogo :display="'inline-block'"></BrandLogo>
                            </div>
                            <div>
            ...
            <div class="mx-[50px] py-6 md:flex md:items-center md:justify-between border-t border-t-2 border-white-500">
                <span class="text-sm sm:text-center">© 2024 <a href="https://flowbite.com/">Your company™</a>. All Rights
                    Reserved.
                </span>
